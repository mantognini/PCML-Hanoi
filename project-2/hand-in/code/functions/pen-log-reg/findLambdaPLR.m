function lambda = findLambdaPLR(y, tX, K)
%
% Find the best lambda for Penalized Logistic Regression
    ...
    for l = 1:length(lambdas)
        ...
        for k = 1:K
            ...
            mseTeSub(k) = BER(yTe, sigmToZeroOne(sigmoid(tXTe * beta)));
            mseTrSub(k) = BER(yTr, sigmToZeroOne(sigmoid(tXTr * beta)));
